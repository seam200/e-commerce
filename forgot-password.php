...
if (isset($_POST['change'])) {
	...
	if ($num > 0) {
		...
		$_SESSION['errmsg'] = "Thank you. Ekhon Bazar.com Password Changed Successfully";
		exit();
	} else {
		$extra = "forgot-password.php";
		$host  = $_SERVER['HTTP_HOST'];
...
<head>
	...
	<title>Ekhon Bazar.com | Forgot Password</title>
					...
					<div class="col-md-6 col-sm-6 sign-in">
						...
						<form class="register-form outer-top-xs" name="register" method="post">
							...
							<div class="form-group">
								...
								<input type="text" name="contact" class="form-control unicase-form-control text-input" id="contact" required maxlength="11">
							</div>
							<div class="form-group">
