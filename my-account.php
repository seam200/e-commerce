...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		if ($query) {
			echo "<script>alert('Thank you. Ekhon Bazar.com Your info has been updated');</script>";
		}
	}
	...
	if (isset($_POST['submit'])) {
		...
		if ($num > 0) {
			...
			echo "<script>alert('Thank you. Ekhon Bazar.com Your Password Changed Successfully !!');</script>";
		} else {
			echo "<script>alert('Sorr! Ekhon Bazar.com Your Current Password not match !!');</script>";
		}
	}
...
?>
	...
	<head>
		...
		<title>Ekhon Bazar.com | My Account</title>
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											...
											<form class="register-form" role="form" method="post" name="chngpwd" onSubmit="return valid();">
												...
												<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Change Password</button>
											</form>
										</div>
									</div>
								</div>
