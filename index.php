...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	echo "<script>alert('Thank you. Ekhon Bazar.com Product has been added to the cart')</script>";
...
<head>
	...
	<title>Ekhon Bazar.com | Home</title>
								...
								<div class="row">
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												<div class="col-xs-2">
													<i class="icon fa fa-bangladeshi-taka-sign"></i>
												</div>
												<div class="col-xs-10">
													<h4 class="info-box-heading green">Money back</h4>
												</div>
											</div>
											<h6 class="text">3 Days Money Back Guaranteed.</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">Free Shipping on oder over BDT. 999.00</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading red">Best Products</h4>
												</div>
											</div>
											<h6 class="text">We offer 100% original products guaranteed.</h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
					<div class="more-info-tab clearfix">
						...
						<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
							...
							<li><a href="#books" data-toggle="tab">Homemade</a></li>
							<li><a href="#furniture" data-toggle="tab">Natural</a></li>
						</ul><!-- /.nav-tabs -->
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Regular Products</h3>
