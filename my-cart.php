...
if (isset($_POST['submit'])) {
	if (!empty($_SESSION['cart'])) {
		...
		echo "<script>alert('Thank You. Ekhon Bazar.com Your Cart hasbeen Updated');</script>";
	}
}
...
if (isset($_POST['update'])) {
	...
	if ($query) {
		echo "<script>alert('Thank you. Ekhon Bazar.com Your Billing Address has been updated');</script>";
	}
}
...
if (isset($_POST['shipupdate'])) {
	...
	if ($query) {
		echo "<script>alert('Thank you. Ekhon Bazar.com Your Shipping Address has been updated');</script>";
	}
}
...
<head>
	...
	<title>Ekhon Bazar.com | My Cart</title>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing Pincode">Billing Pincode/Zipcode <span>*</span></label>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing Pincode">Shipping Pincode/Zipcode <span>*</span></label>
